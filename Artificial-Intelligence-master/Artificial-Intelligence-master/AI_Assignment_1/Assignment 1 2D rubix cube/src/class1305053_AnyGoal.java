...
public class class1305053_AnyGoal
{
    ...
    public static void main(String[] args)
    {
        ...
        while (true)
        {
            ...
            for(State i:Q)
            {
                if( match(i,goalA,r,c) || match(i,goalB,r,c) || match(i,goalC,r,c) || match(i,goalD,r,c) )
                {
                    printFromRoot(i);
            ...
            for(State i:Q)
            {
                int d1= (distanceFromGoal(i,goalA,r,c)+ i.level);
                int d2= (distanceFromGoal(i,goalB,r,c)+ i.level);
                int d3= (distanceFromGoal(i,goalC,r,c)+ i.level);
                int d4= (distanceFromGoal(i,goalD,r,c)+ i.level);

                int d= MIN( d1 , MIN( d2 , MIN(d3,d4) ) );

                if( d < min && isAlreadyUsed(UsedState,i,r,c)==false)
                {
                    min=d;
                    current=i;
                }
